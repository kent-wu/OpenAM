...
import org.forgerock.openam.selfservice.config.flows.WeiboUserRegistrationConfigProvider;
 ...
 * @since 13.0.0
 */
public final class WeiboUserRegistrationConsoleConfig extends CommonConsoleConfig {
    ...
    private WeiboUserRegistrationConsoleConfig(WeiboUserRegistrationBuilder builder) {
        super(builder);
    ...
    /**
     * Builder for {@link WeiboUserRegistrationConsoleConfig}.
     */
    @ConfigSource({"MailServer", "selfService"})
    public static final class WeiboUserRegistrationBuilder
            extends CommonConsoleConfigBuilder<WeiboUserRegistrationConsoleConfig> {
         ...
         */
        public WeiboUserRegistrationBuilder() {
...
//            this.configProviderClass = configProviderClass;
            this.configProviderClass = WeiboUserRegistrationConfigProvider.class.getName(); 
        }
        ...
        @Override
        WeiboUserRegistrationConsoleConfig internalBuild() {
            ...
            return new WeiboUserRegistrationConsoleConfig(this);
        }
